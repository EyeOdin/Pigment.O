...
class PigmentOExtension(Extension):
    ...
    def SOF_1_Minus(self):
        try:
            ...
            # Calculations
            sof[0] = sof[0] - (self.sof_1)
            if sof[0] <= 0:
                sof[0] = 0
            # Apply variation Color
            self.SOF_2_Krita("SIZE", sof[0])
    ...
    def SOF_2_Minus(self):
        try:
            ...
            sof = self.Krita_2_SOF()
            # Calculations
            sof[1] = sof[1] - (self.sof_23)
            if sof[1] <= 0:
                sof[1] = 0
            # Apply variation Color
            self.SOF_2_Krita("OPACITY", sof[1])
            # Reactivate Eraser after Application
            if eraser == True:
                kritaEraserAction.trigger()
        except:
    ...
    def SOF_3_Minus(self):
        try:
            ...
            sof = self.Krita_2_SOF()
            # Calculations
            sof[2] = sof[2] - (self.sof_23)
            if sof[2] <= 0:
                sof[2] = 0
            # Apply variation Color
            self.SOF_2_Krita("FLOW", sof[2])
            # Reactivate Eraser after Application
            if eraser == True:
                kritaEraserAction.trigger()
        except:
...
class PigmentODocker(DockWidget):
    ...
    def Dots(self):
        # Display
        self.panel_dots = Panel_DOT(self.layout.dot_mix)
    ...
    def Style_Widget(self):
        ...
        self.layout.dot_mix.setStyleSheet(bg_alpha)
    ...
    def Menu_UI1(self, save):
        if self.layout.option.isChecked() == True:
            ...
            # Spacing
            self.layout.options_1.setContentsMargins(zero, unit, zero, unit)
            self.layout.options_2.setContentsMargins(zero, unit, zero, unit)
        else:
            try:
                # Icon
                self.icon_corner = self.Icon_Corner(self.gray_contrast)
    ...
    def Menu_UI2(self, save):
        if self.layout.menu.isChecked() == True:
            ...
            # Spacing
            self.layout.menus.setContentsMargins(10, 10, 10, 10)
            self.layout.menus.setSpacing(6)
        else:
            try:
                # Icon
                self.icon_menu = self.Icon_Menu(self.gray_contrast)
            ...
            # Spacing
            self.layout.menus.setContentsMargins(zero, zero, zero, zero)
            self.layout.menus.setSpacing(0)
        if save == "SAVE":
            self.Pigment_Display()
            self.Settings_Save_UI()
    ...
    def Menu_HAR(self, save):
        ...
        if har_active == False:
            ...
            self.layout.color_1.setMinimumHeight(ui_40)
            self.layout.color_1.setMaximumHeight(ui_40)
            self.layout.color_2.setMinimumHeight(ui_40)
            self.layout.color_2.setMaximumHeight(ui_40)
        ...
        if (har_active == True and har_index == "Monochromatic"):
            ...
            self.layout.harmony_1.setMinimumHeight(ui_30)
            self.layout.harmony_1.setMaximumHeight(ui_30)
            self.layout.harmony_2.setMinimumHeight(ui_30)
            self.layout.harmony_2.setMaximumHeight(ui_30)
            self.layout.harmony_3.setMinimumHeight(ui_30)
            self.layout.harmony_3.setMaximumHeight(ui_30)
            self.layout.harmony_4.setMinimumHeight(ui_30)
            self.layout.harmony_4.setMaximumHeight(ui_30)
            self.layout.harmony_5.setMinimumHeight(ui_30)
            self.layout.harmony_5.setMaximumHeight(ui_30)
            self.layout.color_harmonys.setContentsMargins(zero, zero, zero, zero)
    ...
    def Menu_PAN(self, save):
        ...
        if pan_index == "HUE":
            ...
            self.Pigment_Convert("RGB", 0)
        if (pan_active == True and pan_index == "GAM"):
            font.setBold(True)
            self.panel_active = "GAM"
    ...
    def Menu_DOT(self, save):
        ...
        if self.layout.dot.isChecked():
            ...
            self.layout.dot_mix.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
            ...
            self.layout.dots.setContentsMargins(zero, unit, zero, unit)
            self.layout.dots.setSpacing(2)
            self.Spacer_Vertical()
        else:
            font.setBold(False)
            self.dot_active = False
            self.layout.dot_mix.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
            ...
            self.layout.dots.setContentsMargins(zero, zero, zero, zero)
            self.layout.dots.setSpacing(0)
            self.Spacer_Vertical()
    ...
    def OBJ_Shrink_Top(self):
        # Object View Shrink
        self.layout.layers.setContentsMargins(zero, zero, zero, zero)
    ...
    def OBJ_Scale_Bot(self):
        # Margins
        self.layout.objects.setContentsMargins(zero, unit, zero, unit)
        # BackGround 1
        ...
        # Spacer
        self.layout.spacer_object.setMinimumHeight(ui_5)
        self.layout.spacer_object.setMaximumHeight(ui_5)
    def OBJ_Save(self):
    ...
    def Update_DOT(self):
        self.panel_dots.Update_Panel(
            ...
            self.dot_3,
            self.dot_4,
            self.layout.dot_mix.width(),
            self.layout.dot_mix.height()
            )
    ...
    def Ratio(self):
        ...
        if self.layout.dot.isChecked() == True:
            self.panel_dots.Location(self.dot_location_x, self.dot_location_y, self.layout.dot_mix.width(), self.layout.dot_mix.height())

        # Relocate Object Alpha Handle due to Size Variation
        if self.obj_active == True:
            self.Object_Render()
            self.Object_Alpha()
            self.panel_obj.Location(self.obj_location_x, self.obj_location_y, self.layout.layers_widget.width(), self.layout.layers_widget.height())
    ...
    def Box_Ratio(self):
        ...
        # Harmony Ratio Adjust to maintain Square
        har_width = self.layout.panel_gam.width()
        har_height = self.layout.panel_gam.height()
        if har_width <= 0:
            har_width = 1
        if har_height <= 0:
            har_height = 1
        if har_width >= har_height:
            self.layout.panel_gam_mask.setMaximumWidth(har_height)
            self.layout.panel_gam_mask.setMaximumHeight(har_height)
        if har_width < har_height:
            self.layout.panel_gam_mask.setMaximumWidth(har_width)
            self.layout.panel_gam_mask.setMaximumHeight(har_width)
    ...
    def Signal_DOT(self, SIGNAL_DOT_VALUE):
        # Geometry
        width = self.layout.dot_mix.width()
        height = self.layout.dot_mix.height()
        pixmap = self.layout.dot_mix.grab(QRect(QPoint(0, 0), QPoint(width, height)))
    ...
    def Object_Geometry(self):
        ...
        self.layout.layer_cursor.setGeometry(0,0,self.layout.layers_widget.width(),self.layout.layers_widget.height())
