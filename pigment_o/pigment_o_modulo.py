...
class Panel_IMG(QWidget):
    ...
    def mouseCursor(self, event):
        ...
        if (event.buttons() == QtCore.Qt.LeftButton and event.modifiers() == QtCore.Qt.AltModifier):
            self.Context_Clean()
        # Operations Right
        if (event.buttons() == QtCore.Qt.RightButton and event.modifiers() == QtCore.Qt.ShiftModifier): # Offset
        ...
        if (event.buttons() == QtCore.Qt.RightButton and event.modifiers() == QtCore.Qt.ControlModifier): # Zoom
            ...
            if self.zoom <= 0:
                self.zoom = 0
        if (event.buttons() == QtCore.Qt.RightButton and event.modifiers() == QtCore.Qt.AltModifier): # Reset
            self.Context_Reset()
