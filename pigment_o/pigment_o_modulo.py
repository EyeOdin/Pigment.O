...
class Menu_Event(QWidget):
    SIGNAL_STRING = QtCore.pyqtSignal(str)

    def __init__(self, parent):
        super(Menu_Event, self).__init__(parent)

    def Setup(self, string):
        self.string = string
    def enterEvent(self, event):
        self.SIGNAL_STRING.emit("OPEN")
    def leaveEvent(self, event):
        self.SIGNAL_STRING.emit("CLOSE")
...
class Object_Pixel(QWidget):
    SIGNAL_OBJECT = QtCore.pyqtSignal(list)

    def __init__(self, parent):
        super(Object_Pixel, self).__init__(parent)
    ...
    def mouseCursor(self, event):
        ...
        self.SIGNAL_OBJECT.emit(position)
