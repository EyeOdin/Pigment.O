...
class PanelHsv(QWidget):
    ...
    SIGNAL_HSV_OLD = QtCore.pyqtSignal(list)
    ...
    def __init__(self, parent):
        ...
        # Thread mouse Input
        self.thread_hsv_1 = threading.Thread(target=self.mouseCursor, daemon=True)
        self.thread_hsv_2 = threading.Thread(target=self.tabletCursor, daemon=True)
        self.thread_hsv_3 = threading.Thread(target=self.Update_Panel, daemon=True)
        self.thread_hsv_1.start()
        self.thread_hsv_2.start()
        self.thread_hsv_3.start()
