...
class PigmentODocker(DockWidget):
    ...
    def Mixers(self):
        ...
        self.boot_black = [0*factorAAA, 0*factorRGB,0*factorRGB,0*factorRGB, 0*factorHUE,0*factorSVL,0*factorSVL, 0*factorHUE,0*factorSVL,0*factorSVL, 0*factorCMYK,0*factorCMYK,0*factorCMYK,1*factorCMYK]
        self.color_rgb_l1 = self.boot_black
        self.color_rgb_l2 = self.boot_black
        self.color_rgb_l3 = self.boot_black
        self.color_rgb_r1 = self.boot_black
        self.color_rgb_r2 = self.boot_black
        self.color_rgb_r3 = self.boot_black
        self.color_hsv_l1 = self.boot_black
        self.color_hsv_l2 = self.boot_black
        self.color_hsv_l3 = self.boot_black
        self.color_hsv_r1 = self.boot_black
        self.color_hsv_r2 = self.boot_black
        self.color_hsv_r3 = self.boot_black
        self.color_hsl_l1 = self.boot_black
        self.color_hsl_l2 = self.boot_black
        self.color_hsl_l3 = self.boot_black
        self.color_hsl_r1 = self.boot_black
        self.color_hsl_r2 = self.boot_black
        self.color_hsl_r3 = self.boot_black
        self.color_cmyk_l1 = self.boot_black
        self.color_cmyk_l2 = self.boot_black
        self.color_cmyk_l3 = self.boot_black
        self.color_cmyk_r1 = self.boot_black
        self.color_cmyk_r2 = self.boot_black
        self.color_cmyk_r3 = self.boot_black
