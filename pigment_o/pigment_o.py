...
class PigmentODocker(DockWidget):
    ...
    def Object(self):
        # PNGs Path
        self.path_bg_1 = str(self.dir_name + "/Object/bg_1.png")
        self.path_bg_2 = str(self.dir_name + "/Object/bg_2.png")
        self.path_bg_3 = str(self.dir_name + "/Object/bg_3.png")
        self.path_dif_1 = str(self.dir_name + "/Object/dif_1.png")
        self.path_dif_2 = str(self.dir_name + "/Object/dif_2.png")
        self.path_dif_3 = str(self.dir_name + "/Object/dif_3.png")
        self.path_dif_4 = str(self.dir_name + "/Object/dif_4.png")
        self.path_dif_5 = str(self.dir_name + "/Object/dif_5.png")
        self.path_dif_6 = str(self.dir_name + "/Object/dif_6.png")
        self.path_fg_1 = str(self.dir_name + "/Object/fg_1.png")
        self.path_fg_2 = str(self.dir_name + "/Object/fg_2.png")
        self.path_fg_3 = str(self.dir_name + "/Object/fg_3.png")
        ...
        # Style Sheets
        self.layout.panel_layers.setStyleSheet(bg_gradient)
    ...
    def Menu_Options(self, save):
        if self.layout.option.isChecked() == True:
            ...
            self.layout.sof_sliders.setMinimumHeight(ui_menu)
            self.layout.sof_sliders.setMaximumHeight(ui_menu)
            self.layout.gray_sliders.setMinimumHeight(ui_menu)
            self.layout.gray_sliders.setMaximumHeight(ui_menu)
            self.layout.gray_panels.setMinimumHeight(ui_menu)
            self.layout.gray_panels.setMaximumHeight(ui_menu)
        else:
            # Options 1
            ...
            self.layout.sof_sliders.setMinimumHeight(zero)
            self.layout.sof_sliders.setMaximumHeight(zero)
            self.layout.gray_sliders.setMinimumHeight(zero)
            self.layout.gray_sliders.setMaximumHeight(zero)
            self.layout.gray_panels.setMinimumHeight(zero)
            self.layout.gray_panels.setMaximumHeight(zero)
        if save == "SAVE":
    ...
    def Menu_OBJ(self, save):
        ...
        if self.layout.obj.isChecked():
            ...
            self.layout.panel_layers.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        else:
            font.setBold(False)
            # BackGround 1
            ...
            self.layout.panel_layers.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
    ...
    def Pigment_Display(self):
        ...
        # Object
        if self.layout.obj.isChecked() == True:
            self.Object_Live()
            self.Object_Render()
            self.Object_Alpha()
    ...
    def Object_Render(self):
        ...
        self.layout.layer_01.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_02.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_03.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_04.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_05.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_06.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_07.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_08.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_09.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_10.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_11.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        self.layout.layer_12.setGeometry(0,0,self.layout.panel_layers.width(),self.layout.panel_layers.height())
        # Render Layers
        if self.bg_1[0] == "True":
            self.layout.layer_01.setPixmap(self.Mask_Color(self.path_bg_1, self.bg_1[1]*255, self.bg_1[2]*255, self.bg_1[3]*255, self.bg_1[4]*255))
    ...
    def Settings_UI(self):
        ...
        try:
            ...
            self.layout.obj.setChecked(eval(ui_split[11]))
            self.layout.sof_sliders.setChecked(False)
            self.layout.gray_sliders.setChecked(False)
            self.layout.gray_panels.setChecked(False)
        except:
    ...
    def Settings_Colors(self):
        ...
        try:
            ...
            # All Clean Channels Reset
            if (
            self.bg_1[0] == "False" and
            self.bg_2[0] == "False" and
            self.bg_3[0] == "False" and
            self.dif_1[0] == "False" and
            self.dif_2[0] == "False" and
            self.dif_3[0] == "False" and
            self.dif_4[0] == "False" and
            self.dif_5[0] == "False" and
            self.dif_6[0] == "False" and
            self.fg_1[0] == "False" and
            self.fg_2[0] == "False" and
            self.fg_3[0] == "False"):
                self.bg_1 = ["True", 0, 0, 0, 1]
