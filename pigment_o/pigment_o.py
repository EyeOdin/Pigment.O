...
class PigmentODocker(DockWidget):
    ...
    def Connect(self):
        ...
        self.layout.gray.toggled.connect(self.Menu_Gray)
    ...
    def Signal_Send_Panels(self):
        self.UVD_Update()
        self.panel_hsv.Update_Panel(self.hsv_2, self.hsv_3, self.layout.panel_hsv_fg.width(), self.layout.panel_hsv_fg.height(), self.HEX_6_SVG(), self.zoom)
        self.panel_hsl.Update_Panel(self.hsl_2, self.hsl_3, self.layout.panel_hsl_fg.width(), self.layout.panel_hsl_fg.height(), self.HEX_6_SVG(), self.zoom)
    ...
    def Pigment_Display(self):
        ...
        # ARD
        if (self.layout.aaa.isChecked() == True and self.layout.gray.isChecked() == False):
            sss_aaa = str(self.RGB_Gradient([0, 0, 0], [1, 1, 1]))
        else:
            sss_aaa = bg_alpha
        # RGB
        if (self.layout.rgb.isChecked() == True and self.layout.gray.isChecked() == False):
            ...
            sss_rgb3 = bg_alpha
        # ARD
        if (self.layout.ard.isChecked() == True and self.layout.gray.isChecked() == False):
            ...
            sss_ard3 = bg_alpha
        # HSV
        if (self.layout.hsv.isChecked() == True and self.layout.gray.isChecked() == False):
            ...
            sss_hsv3 = bg_alpha
        # HSL
        if (self.layout.hsl.isChecked() == True and self.layout.gray.isChecked() == False):
            ...
            sss_hsl3 = bg_alpha
        # CMYK
        if (self.layout.cmyk.isChecked() == True and self.layout.gray.isChecked() == False):
        ...
        # Foreground Color
        if (panel == "FGC" or panel == "G_FGC"):
            if panel == "FGC":
                foreground_color = str("QWidget { background-color: rgb(%f, %f, %f); }" % (self.rgb_1*kritaRGB, self.rgb_2*kritaRGB, self.rgb_3*kritaRGB))
        ...
        if (panel == "HSV" or panel == "G_HSV"):
            ...
            if panel == "G_HSV":
                ...
                base_value = str("QWidget { background-color: rgb(%f, %f, %f); }" % (self.aaa_1*kritaRGB, self.aaa_1*kritaRGB, self.aaa_1*kritaRGB))
                self.layout.panel_hsv_fg.setStyleSheet(base_value)
        else:
            self.layout.panel_hsv_bg.setStyleSheet(bg_unseen)
    ...
    def RGB_Gradient(self, color_left, color_right):
        ...
        % (color_left[0]*255, color_left[1]*255, color_left[2]*255, color_right[0]*255, color_right[1]*255, color_right[2]*255)
        )
    ...
    def Settings_Load(self):
        ...
        try:
            ...
            self.layout.gray.setChecked(eval(ui_split[10]))
        except:
