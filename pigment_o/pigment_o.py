...
class PigmentODocker(DockWidget):
    ...
    def Display_RGB(self):
        if self.layout.rgb.isChecked():
            ...
            self.layout.rgb_1_label.setMinimumHeight(cmin)
            self.layout.rgb_1_label.setMaximumHeight(cmax)
            self.layout.rgb_1_minus.setMinimumHeight(cmin)
            self.layout.rgb_1_minus.setMaximumHeight(cmax)
            self.layout.rgb_1_slider.setMinimumHeight(cmin)
            self.layout.rgb_1_slider.setMaximumHeight(cmax)
            self.layout.rgb_1_plus.setMinimumHeight(cmin)
            self.layout.rgb_1_plus.setMaximumHeight(cmax)
            self.layout.rgb_1_value.setMinimumHeight(cmin)
            self.layout.rgb_1_value.setMaximumHeight(cmax)
            self.layout.rgb_1_tick.setMinimumHeight(unit)
            self.layout.rgb_2_label.setMinimumHeight(cmin)
            self.layout.rgb_2_label.setMaximumHeight(cmax)
            self.layout.rgb_2_minus.setMinimumHeight(cmin)
            self.layout.rgb_2_minus.setMaximumHeight(cmax)
            self.layout.rgb_2_slider.setMinimumHeight(cmin)
            self.layout.rgb_2_slider.setMaximumHeight(cmax)
            self.layout.rgb_2_plus.setMinimumHeight(cmin)
            self.layout.rgb_2_plus.setMaximumHeight(cmax)
            self.layout.rgb_2_value.setMinimumHeight(cmin)
            self.layout.rgb_2_value.setMaximumHeight(cmax)
            self.layout.rgb_2_tick.setMinimumHeight(unit)
            self.layout.rgb_3_label.setMinimumHeight(cmin)
            self.layout.rgb_3_label.setMaximumHeight(cmax)
            self.layout.rgb_3_minus.setMinimumHeight(cmin)
            self.layout.rgb_3_minus.setMaximumHeight(cmax)
            self.layout.rgb_3_slider.setMinimumHeight(cmin)
            self.layout.rgb_3_slider.setMaximumHeight(cmax)
            self.layout.rgb_3_plus.setMinimumHeight(cmin)
            self.layout.rgb_3_plus.setMaximumHeight(cmax)
            self.layout.rgb_3_value.setMinimumHeight(cmin)
            self.layout.rgb_3_value.setMaximumHeight(cmax)
    ...
    def Display_HSV(self):
        if self.layout.hsv.isChecked():
            ...
            self.layout.hsv_1_label.setMinimumHeight(cmin)
            self.layout.hsv_1_label.setMaximumHeight(cmax)
            self.layout.hsv_1_minus.setMinimumHeight(cmin)
            self.layout.hsv_1_minus.setMaximumHeight(cmax)
            self.layout.hsv_1_slider.setMinimumHeight(cmin)
            self.layout.hsv_1_slider.setMaximumHeight(cmax)
            self.layout.hsv_1_plus.setMinimumHeight(cmin)
            self.layout.hsv_1_plus.setMaximumHeight(cmax)
            self.layout.hsv_1_value.setMinimumHeight(cmin)
            self.layout.hsv_1_value.setMaximumHeight(cmax)
            self.layout.hsv_1_tick.setMinimumHeight(unit)
            self.layout.hsv_2_label.setMinimumHeight(cmin)
            self.layout.hsv_2_label.setMaximumHeight(cmax)
            self.layout.hsv_2_minus.setMinimumHeight(cmin)
            self.layout.hsv_2_minus.setMaximumHeight(cmax)
            self.layout.hsv_2_slider.setMinimumHeight(cmin)
            self.layout.hsv_2_slider.setMaximumHeight(cmax)
            self.layout.hsv_2_plus.setMinimumHeight(cmin)
            self.layout.hsv_2_plus.setMaximumHeight(cmax)
            self.layout.hsv_2_value.setMinimumHeight(cmin)
            self.layout.hsv_2_value.setMaximumHeight(cmax)
            self.layout.hsv_2_tick.setMinimumHeight(unit)
            self.layout.hsv_3_label.setMinimumHeight(cmin)
            self.layout.hsv_3_label.setMaximumHeight(cmax)
            self.layout.hsv_3_minus.setMinimumHeight(cmin)
            self.layout.hsv_3_minus.setMaximumHeight(cmax)
            self.layout.hsv_3_slider.setMinimumHeight(cmin)
            self.layout.hsv_3_slider.setMaximumHeight(cmax)
            self.layout.hsv_3_plus.setMinimumHeight(cmin)
            self.layout.hsv_3_plus.setMaximumHeight(cmax)
            self.layout.hsv_3_value.setMinimumHeight(cmin)
            self.layout.hsv_3_value.setMaximumHeight(cmax)
    ...
    def Display_TTS(self):
        if self.layout.tts.isChecked():
            ...
            self.layout.neutral.setMinimumHeight(cmin2)
            self.layout.neutral.setMaximumHeight(cmax2)
            self.layout.tint.setMinimumHeight(cmin)
            self.layout.tint.setMaximumHeight(cmax)
            self.layout.tone.setMinimumHeight(cmin)
            self.layout.tone.setMaximumHeight(cmax)
            self.layout.shade.setMinimumHeight(cmin)
            self.layout.shade.setMaximumHeight(cmax)
            self.layout.white.setMinimumHeight(cmin)
            self.layout.white.setMaximumHeight(cmax)
            self.layout.grey.setMinimumHeight(cmin)
            self.layout.grey.setMaximumHeight(cmax)
            self.layout.black.setMinimumHeight(cmin)
            self.layout.black.setMaximumHeight(cmax)
    ...
    def Display_MIX1(self):
        if self.layout.mix1.isChecked():
            ...
            self.layout.rgb_l1.setMinimumHeight(cmin)
            self.layout.rgb_l1.setMaximumHeight(cmax)
            self.layout.rgb_l2.setMinimumHeight(cmin)
            self.layout.rgb_l2.setMaximumHeight(cmax)
            self.layout.rgb_l3.setMinimumHeight(cmin)
            self.layout.rgb_l3.setMaximumHeight(cmax)
            self.layout.rgb_r1.setMinimumHeight(cmin)
            self.layout.rgb_r1.setMaximumHeight(cmax)
            self.layout.rgb_r2.setMinimumHeight(cmin)
            self.layout.rgb_r2.setMaximumHeight(cmax)
            self.layout.rgb_r3.setMinimumHeight(cmin)
            self.layout.rgb_r3.setMaximumHeight(cmax)
            self.layout.rgb_g1.setMinimumHeight(cmin)
            self.layout.rgb_g1.setMaximumHeight(cmax)
            self.layout.rgb_g2.setMinimumHeight(cmin)
            self.layout.rgb_g2.setMaximumHeight(cmax)
            self.layout.rgb_g3.setMinimumHeight(cmin)
            self.layout.rgb_g3.setMaximumHeight(cmax)
    ...
    def Display_MIX2(self):
        if self.layout.mix2.isChecked():
            ...
            self.layout.hsv_l1.setMinimumHeight(cmin)
            self.layout.hsv_l1.setMaximumHeight(cmax)
            self.layout.hsv_l2.setMinimumHeight(cmin)
            self.layout.hsv_l2.setMaximumHeight(cmax)
            self.layout.hsv_l3.setMinimumHeight(cmin)
            self.layout.hsv_l3.setMaximumHeight(cmax)
            self.layout.hsv_r1.setMinimumHeight(cmin)
            self.layout.hsv_r1.setMaximumHeight(cmax)
            self.layout.hsv_r2.setMinimumHeight(cmin)
            self.layout.hsv_r2.setMaximumHeight(cmax)
            self.layout.hsv_r3.setMinimumHeight(cmin)
            self.layout.hsv_r3.setMaximumHeight(cmax)
            self.layout.hsv_g1.setMinimumHeight(cmin)
            self.layout.hsv_g1.setMaximumHeight(cmax)
            self.layout.hsv_g2.setMinimumHeight(cmin)
            self.layout.hsv_g2.setMaximumHeight(cmax)
            self.layout.hsv_g3.setMinimumHeight(cmin)
            self.layout.hsv_g3.setMaximumHeight(cmax)
