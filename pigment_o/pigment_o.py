...
class PigmentODocker(DockWidget):
    ...
    def Setup(self):
        ...
        self.Display_TTS()
        self.layout.cor.setChecked(False)
        self.Display_Cores()
        # Mixer Selection
        self.Mixer_Shrink()
    ...
    def Connect(self):
        ...
        self.layout.cor.toggled.connect(self.Display_Cores)
    ...
    def Click_Twice(self):
        # Brush Reset
        self.tip = Clicks(self.layout.tip)
        self.tip.SIGNAL_CLICKS.connect(self.Brush_Lock)
        # Palette Colors
    ...
    def Display_Cores(self):
        font = self.layout.cor.font()
        if self.layout.cor.isChecked():
            font.setBold(True)
            self.layout.cor_01.setMinimumHeight(cmin3)
            self.layout.cor_01.setMaximumHeight(cmax3)
            self.layout.cor_02.setMinimumHeight(cmin3)
            self.layout.cor_02.setMaximumHeight(cmax3)
            self.layout.cor_03.setMinimumHeight(cmin3)
            self.layout.cor_03.setMaximumHeight(cmax3)
            self.layout.cor_04.setMinimumHeight(cmin3)
            self.layout.cor_04.setMaximumHeight(cmax3)
            self.layout.cor_05.setMinimumHeight(cmin3)
            self.layout.cor_05.setMaximumHeight(cmax3)
            self.layout.cor_06.setMinimumHeight(cmin3)
            self.layout.cor_06.setMaximumHeight(cmax3)
            self.layout.cor_07.setMinimumHeight(cmin3)
            self.layout.cor_07.setMaximumHeight(cmax3)
            self.layout.cor_08.setMinimumHeight(cmin3)
            self.layout.cor_08.setMaximumHeight(cmax3)
            self.layout.cor_09.setMinimumHeight(cmin3)
            self.layout.cor_09.setMaximumHeight(cmax3)
            self.layout.cor_10.setMinimumHeight(cmin3)
            self.layout.cor_10.setMaximumHeight(cmax3)
