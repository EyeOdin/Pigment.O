...
class PigmentODocker(DockWidget):
    ...
    def Connect(self):
        ...
        # Channel KELVIN
        self.layout.kkk_1_label.clicked.connect(self.Pigment_KKK_1_Influence)
        self.layout.kkk_1_minus.clicked.connect(self.Pigment_KKK_1_Minus)
        self.layout.kkk_1_plus.clicked.connect(self.Pigment_KKK_1_Plus)
    ...
    def Style_Sheet(self):
        ...
        self.layout.percentage_ard_1.setStyleSheet(bg_unseen)
        self.layout.percentage_ard_2.setStyleSheet(bg_unseen)
    ...
    def Menu_KKK(self, save):
        ...
        if self.layout.kkk.isChecked():
            font.setBold(True)
            self.layout.kkk_1_label.setMinimumHeight(ui_min_1)
            self.layout.kkk_1_label.setMaximumHeight(ui_max_1)
            self.layout.kkk_1_minus.setMinimumHeight(ui_min_1)
            self.layout.kkk_1_minus.setMaximumHeight(ui_max_1)
            self.layout.kkk_1_slider.setMinimumHeight(ui_min_1)
            self.layout.kkk_1_slider.setMaximumHeight(ui_max_1)
            self.layout.kkk_1_plus.setMinimumHeight(ui_min_1)
            self.layout.kkk_1_plus.setMaximumHeight(ui_max_1)
            self.layout.kkk_1_value.setMinimumHeight(ui_min_1)
            self.layout.kkk_1_value.setMaximumHeight(ui_max_1)
            ...
            self.layout.kkk_1_minus.setMinimumHeight(zero)
            self.layout.kkk_1_minus.setMaximumHeight(zero)
            self.layout.kkk_1_slider.setMinimumHeight(zero)
            self.layout.kkk_1_slider.setMaximumHeight(zero)
            self.layout.kkk_1_plus.setMinimumHeight(zero)
            self.layout.kkk_1_plus.setMaximumHeight(zero)
    ...
    def Menu_Percentage(self):
        ...
        self.layout.cmyk.isChecked() == True or
        self.layout.kkk.isChecked() == True):
            ten = self.Percentage("TEN")
            self.layout.percentage_top.setStyleSheet(ten)
            self.layout.percentage_bot.setStyleSheet(ten)
        ...
        self.layout.cmyk.isChecked() == False and
        self.layout.kkk.isChecked() == False):
    ...
    def Krita_Update(self):
        ...
        if ((self.canvas() is not None) and (self.canvas().view() is not None)):
            state = self.layout.check.checkState()
            influence = self.layout.kkk_1_label.isChecked()
    ...
    def Color_RGB(self, r, g, b):
        ...
        kkk = self.kkk_to_rgb(self.kkk_1)
        # to AAA
        ...
        self.cmyk_4 = cmyk[3]
        # to AAA Kelvin
        self.aaa_k1 = max(self.rgb_1 * kkk[0], self.rgb_2 * kkk[1], self.rgb_3 * kkk[2])
        # to RGB Kelvin
        self.rgb_k1 = self.rgb_1 * kkk[0]
        self.rgb_k2 = self.rgb_2 * kkk[1]
        self.rgb_k3 = self.rgb_3 * kkk[2]
        # to CMYK Kelvin
        kkkk = self.rgb_to_cmyk(self.rgb_k1, self.rgb_k1, self.rgb_k1)
        self.cmyk_k1 = kkkk[0]
        self.cmyk_k2 = kkkk[1]
        self.cmyk_k3 = kkkk[2]
        self.cmyk_k3 = kkkk[3]
    ...
    def Pigment_Convert_AAA(self):
        ...
        self.cmyk_4 = cmyk[3]
        # to AAA Kelvin
        self.aaa_k1 = max(self.aaa_1 * kkk[0], self.aaa_1 * kkk[1], self.aaa_1 * kkk[2])
        # to RGB Kelvin
        self.rgb_k1 = self.rgb_1 * kkk[0]
        self.rgb_k2 = self.rgb_2 * kkk[1]
        self.rgb_k3 = self.rgb_3 * kkk[2]
    ...
    def Pigment_Convert_ARD(self, ignore):
        ...
        self.cmyk_4 = cmyk[3]
        # to AAA Kelvin
        self.aaa_k1 = max(rgb[0] * kkk[0], rgb[1] * kkk[1], rgb[2] * kkk[2])
        # to RGB Kelvin
        self.rgb_k1 = rgb[0] * kkk[0]
        self.rgb_k2 = rgb[1] * kkk[1]
        self.rgb_k3 = rgb[2] * kkk[2]
        # to CMYK Kelvin
        kkkk = self.rgb_to_cmyk(self.rgb_k1, self.rgb_k1, self.rgb_k1)
        self.cmyk_k1 = kkkk[0]
        self.cmyk_k2 = kkkk[1]
    ...
    def Pigment_Convert_CMYK(self):
        ...
        self.Pigment_2_Krita()
        self.Pigment_Display()
    def Pigment_Convert_KKK(self):
        if self.layout.kkk_1_label.isChecked() == True:
            # Original
            self.rgb_1 = self.layout.rgb_1_value.value() / kritaRGB
            self.rgb_2 = self.layout.rgb_2_value.value() / kritaRGB
            self.rgb_3 = self.layout.rgb_3_value.value() / kritaRGB
            self.kkk_1 = self.layout.kkk_1_value.value()
            # Converts
            uvd = self.rgb_to_uvd(self.rgb_1, self.rgb_2, self.rgb_3)
            ard = self.uvd_to_ard(uvd[0], uvd[1], uvd[2])
            hsv = self.rgb_to_hsv(self.rgb_1, self.rgb_2, self.rgb_3)
            ...
            # to CMYK Kelvin
            kkkk = self.rgb_to_cmyk(self.rgb_k1, self.rgb_k1, self.rgb_k1)
            self.cmyk_k1 = self.cmyk_1 * kkkk[0]
            self.cmyk_k2 = self.cmyk_2 * kkkk[1]
            self.cmyk_k3 = self.cmyk_3 * kkkk[2]
            self.cmyk_k3 = self.cmyk_3 * kkkk[3]
        if self.layout.kkk_1_label.isChecked() == False:
            # Original
            self.kkk_1 = self.layout.kkk_1_value.value()
            # Converts
            rgb = self.kkk_to_rgb(self.kkk_1)
            uvd = self.rgb_to_uvd(rgb[0], rgb[1], rgb[2])
            ard = self.uvd_to_ard(uvd[0], uvd[1], uvd[2])
            hsv = self.rgb_to_hsv(rgb[0], rgb[1], rgb[2])
            hsl = self.rgb_to_hsl(rgb[0], rgb[1], rgb[2])
    ...
    def Pigment_Sync_AAA(self):
        ...
        self.Signal_Send_KKK(self.kkk_1)
    ...
    def Pigment_Sync_CMYK(self):
        ...
        # Settings
        self.Settings_Save_Color()
    def Pigment_Sync_KKK(self):
        """ Does not recieve from other Sync's"""
        # Block Signals
        self.Signal_Block_AAA(True)
        self.Signal_Block_RGB(True)
        self.Signal_Block_ARD(True)
        ...
        if ((self.canvas() is not None) and (self.canvas().view() is not None)):
            ...
            if (state == 1 or state == 2):
                ...
                if doc[0] == "A":
                    ...
                    if self.layout.kkk_1_label.isChecked() == True:
                        pigment_color.setComponents([self.aaa_k1])
                ...
                if doc[0] == "RGBA":  # RGB with bg_alpha channel (The actual order of channels is most often BGR!)
                    ...
                    if (doc[1] == "U8" or doc[1] == "U16"):
                        ...
                        if self.layout.kkk_1_label.isChecked() == True:
                            pigment_color.setComponents([self.rgb_k3, self.rgb_k2, self.rgb_k1, 1.0])
                    if (doc[1] == "F16" or doc[1] == "F32"):
                        if self.layout.kkk_1_label.isChecked() == False:
                ...
                if doc[0] == "CMYKA":  # CMYK with bg_alpha channel
                    ...
                    if self.layout.kkk_1_label.isChecked() == True:
                        pigment_color.setComponents([self.cmyk_k1, self.cmyk_k2, self.cmyk_k3, self.cmyk_k4, 1.0])
                    Application.activeWindow().activeView().setForeGroundColor(pigment_color)
                    # If Eraser, set it ON again
                    if kritaEraserAction.isChecked():
                        kritaEraserAction.trigger()
    ...
    def Pigment_Display(self):
        ...
        if (self.layout.cmyk.isChecked() == True and self.layout.gray_sliders.isChecked() == False):
            ...
            sss_cmyk4 = bg_alpha
        # KKK
        if (self.layout.kkk.isChecked() == True and self.layout.gray_sliders.isChecked() == False):
            if self.layout.kkk_1_label.isChecked() == False:
        ...
        if panel == "FGC":
            if self.layout.gray_panels.isChecked() == False:
                ...
                if self.layout.kkk_1_label.isChecked() == True:
                    foreground_color = str("QWidget { background-color: rgb(%f, %f, %f); }" % (self.rgb_k1*hexRGB, self.rgb_k2*hexRGB, self.rgb_k3*hexRGB))
    ...
    def Ratio(self):
        ...
        self.kkk_1_slider.Update((self.kkk_1-kritaKKKmin)/kritaKKKdelta, self.layout.kkk_1_slider.width())
    ...
    def Pigment_ARD_1_Half(self):
        ...
        self.Pigment_Convert_ARD("IGNORE")
        self.Pigment_Display_Release(0)
        self.UVD_Release()
    ...
    def Pigment_KKK_1_Influence(self):
        # self.kkk_1 = kritaKKKhalf
        # self.kkk_1_slider.Update((self.kkk_1 - kritaKKKmin) / kritaKKKdelta, self.layout.kkk_1_slider.width())
        # self.layout.kkk_1_value.setValue(self.kkk_1)
        # self.Pigment_Convert_KKK()
        # self.Pigment_Display_Release(0)
        # self.UVD_Release()
        self.Pigment_Convert_RGB()
        self.Pigment_Display_Release(0)
    ...
    def Pigment_KKK_1_Minus(self):
        self.kkk_1 = self.kkk_1 - kritaKKKunit
        if self.kkk_1 <= zero:
            self.kkk_1 = zero
        self.kkk_1_slider.Update((self.kkk_1 - kritaKKKmin) / kritaKKKdelta, self.layout.kkk_1_slider.width())
        self.layout.kkk_1_value.setValue(self.kkk_1)
    ...
    def Pigment_KKK_1_Plus(self):
        self.kkk_1 = self.kkk_1 + kritaKKKunit
        if self.kkk_1 >= kritaKKKmax:
            self.kkk_1 = kritaKKKmax
        self.kkk_1_slider.Update((self.kkk_1 - kritaKKKmin) / kritaKKKdelta, self.layout.kkk_1_slider.width())
        self.layout.kkk_1_value.setValue(self.kkk_1)
        self.Pigment_Convert_KKK()
        self.Pigment_Display_Release(0)
    ...
    def Pigment_KKK_1_Slider_Modify(self, SIGNAL_VALUE):
        self.kkk_1 = int((SIGNAL_VALUE * kritaKKKdelta) + kritaKKKmin)
        self.layout.kkk_1_value.setValue(self.kkk_1)
        self.layout.label_percent.setText(str(round(SIGNAL_VALUE*100,2))+" %")
        self.Pigment_Convert_KKK()
    ...
    def Pigment_KKK_1_Value_Modify(self):
        self.kkk_1 = self.layout.kkk_1_value.value()
        self.kkk_1_slider.Update((self.kkk_1 - kritaKKKmin) / kritaKKKdelta, self.layout.kkk_1_slider.width())
        self.layout.label_percent.setText(str(round(((self.kkk_1 - kritaKKKmin) / kritaKKKdelta)*100,2))+" %")
        self.Pigment_Convert_KKK()
    ...
    def Mixer_ARD_G1(self, SIGNAL_MIXER_VALUE):
        ...
        if self.color_ard_l1[1] <= self.color_ard_r1[1]:
            ...
            if cond1 <= cond2:
                ang = self.color_ard_l1[1] + (self.percentage_ard_g1 * cond1)
            else:
                ang = self.color_ard_l1[1] - (self.percentage_ard_g1 * cond2)
        else:
            # Conditions
    ...
    def Mixer_ARD_G2(self, SIGNAL_MIXER_VALUE):
        ...
        if self.color_ard_l2[1] <= self.color_ard_r2[1]:
            ...
            if cond1 <= cond2:
                ang = self.color_ard_l2[1] + (self.percentage_ard_g2 * cond1)
            else:
                ang = self.color_ard_l2[1] - (self.percentage_ard_g2 * cond2)
        else:
            # Conditions
    ...
    def Mixer_ARD_G3(self, SIGNAL_MIXER_VALUE):
        ...
        if self.color_ard_l3[1] <= self.color_ard_r3[1]:
            ...
            if cond1 <= cond2:
                ang = self.color_ard_l3[1] + (self.percentage_ard_g3 * cond1)
            else:
                ang = self.color_ard_l3[1] - (self.percentage_ard_g3 * cond2)
        else:
            # Conditions
    ...
    def Settings_UI(self):
        ...
        try:
            ...
            self.layout.kkk.setChecked(eval(ui_split[7]))
            self.layout.tip.setChecked(eval(ui_split[8]))
            self.layout.tts.setChecked(eval(ui_split[9]))
            self.layout.mix.setCurrentIndex(int(ui_split[10]))
            self.layout.panel.setCurrentIndex(int(ui_split[11]))
            self.layout.obj.setCurrentIndex(eval(ui_split[12]))
            self.layout.sof_sliders.setChecked(False)
            self.layout.gray_sliders.setChecked(False)
            self.layout.gray_panels.setChecked(False)
        except:
    ...
    def Settings_Colors(self):
        ...
        try:
            ...
            self.kkk_1 = float(active_color_split[7])
            self.UVD_Hexagon_Points()
            self.Color_RGB(self.rgb_1, self.rgb_2, self.rgb_3)
            self.Pigment_Display_Release(0)
        except:
