...
import os.path
# Pigment.O Modules
from .pigment_o_modulo import Channel_Linear, Clicks, Mixer_Gradient, Panel_HSV, Panel_HSL
...
class PigmentODocker(DockWidget):
                    ...
                    if (doc[0] == "A" or doc[0] == "GRAYA"):
                        ...
                        if self.aaa_1 != kac1:
                            if not kritaEraserAction.isChecked():
                                ...
                                # self.layout.label.setText(str(doc[0])+"_1")
                    elif doc[0] == "RGBA":
                        ...
                        if length == 2:
                            ...
                            if (self.rgb_1 != kac1 or self.rgb_2 != kac2 or self.rgb_3 != kac3):
                                if not kritaEraserAction.isChecked():
                                    ...
                                    # self.layout.label.setText(str(doc[0])+"_3")
                                    # Clean Percentage Label Display
                                    self.Pigment_Display_Release(0)
                    elif doc[0] == "CMYKA":
                        length = len(components_fg)
    ...
    def Pigment_Display(self):
        ...
        active_color_1 = str("QWidget { background-color: rgb(%f, %f, %f);}" % (self.rgb_1*kritaRGB, self.rgb_2*kritaRGB, self.rgb_3*kritaRGB))
        self.layout.color_1.setStyleSheet(active_color_1)
        # Alpha
        sss_aaa = str(self.Slider("AAA", 0))
        # RGB
        sss_rgb1 = str(self.Slider("RGB", 0))
        sss_rgb2 = str(self.Slider("RGB", 1))
        sss_rgb3 = str(self.Slider("RGB", 2))
        # HSV
        sss_hsv1 = str(self.Slider("HSV", 0))
        sss_hsv2 = str(self.HSV_Gradient(self.layout.hsv_2_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, 0, self.hsv_3], [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, 1, self.hsv_3]))
        sss_hsv3 = str(self.HSV_Gradient(self.layout.hsv_3_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, 0], [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, 1]))
        # HSL
        sss_hsl1 = str(self.Slider("HSL", 0))
        sss_hsl2 = str(self.HSL_Gradient(self.layout.hsl_2_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, 0, self.hsl_3], [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, 1, self.hsl_3]))
        sss_hsl3 = str(self.HSL_Gradient(self.layout.hsl_3_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, 0], [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, 1]))
        # CMYK
        sss_cmyk1 = str(self.CMYK_Gradient(self.layout.cmyk_1_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, 0, self.cmyk_2, self.cmyk_3, self.cmyk_4], [self.rgb_1, self.rgb_2, self.rgb_3, 1, self.cmyk_2, self.cmyk_3, self.cmyk_4]))
        sss_cmyk2 = str(self.CMYK_Gradient(self.layout.cmyk_2_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, 0, self.cmyk_3, self.cmyk_4], [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, 1, self.cmyk_3, self.cmyk_4]))
        sss_cmyk3 = str(self.CMYK_Gradient(self.layout.cmyk_3_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, 0, self.cmyk_4], [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, 1, self.cmyk_4]))
        sss_cmyk4 = str(self.CMYK_Gradient(self.layout.cmyk_4_slider.width(), [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, 0], [self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, 1]))
        # Apply Style Sheets
        ...
        # Colors for Panels
        if panel == "HSV":
            hue_left = [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, 0, 1]
            hue_right = [self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, 1, 1]
            # base_color = self.HSV_Panel(self.layout.hsv_1_slider.width(), hue_left, hue_right)
            ...
            hue_left = [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, 0, 0.5]
            hue_right = [self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, 1, 0.5]
            # base_color = self.HSL_Panel(self.layout.hsl_1_slider.width(), hue_left, hue_right)
    ...
    def Pigment_Display_Release(self, SIGNAL_RELEASE):
        ...
        active_color_2 = str("QWidget { background-color: rgb(%f, %f, %f);}" % (self.rgb_1*kritaRGB, self.rgb_2*kritaRGB, self.rgb_3*kritaRGB))
    ...
    def HEX_6_SVG(self):
        # Transform into HEX
        hex1 = str(hex(int(self.rgb_1*hexRGB)))[2:4].zfill(2)
        hex2 = str(hex(int(self.rgb_2*hexRGB)))[2:4].zfill(2)
        hex3 = str(hex(int(self.rgb_3*hexRGB)))[2:4].zfill(2)
        pigment_hex = str("#"+hex1+hex2+hex3)
        return pigment_hex
    ...
    def Mixer_HSV_L1_SAVE(self, SIGNAL_SAVE):
        ...
        self.color_hsv_l1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSV_R1_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, V]
        self.color_hsv_r1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSV_L2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, V]
        self.color_hsv_l2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSV_R2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, V]
        self.color_hsv_r2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSV_L3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, V]
        self.color_hsv_l3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSV_R3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, V]
        self.color_hsv_r3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsv_1, self.hsv_2, self.hsv_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_L1_SAVE(self, SIGNAL_SAVE):
        ...
        self.color_hsl_l1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_R1_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, L]
        self.color_hsl_r1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_L2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, L]
        self.color_hsl_l2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_R2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, L]
        self.color_hsl_r2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_L3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, L]
        self.color_hsl_l3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_HSL_R3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, H, S, L]
        self.color_hsl_r3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.hsl_1, self.hsl_2, self.hsl_3]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_L1_SAVE(self, SIGNAL_SAVE):
        ...
        self.color_cmyk_l1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_R1_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, C, M, Y, K]
        self.color_cmyk_r1 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_L2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, C, M, Y, K]
        self.color_cmyk_l2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_R2_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, C, M, Y, K]
        self.color_cmyk_r2 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_L3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, C, M, Y, K]
        self.color_cmyk_l3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Mixer_CMYK_R3_SAVE(self, SIGNAL_SAVE):
        # color = [Bool, R, G, B, C, M, Y, K]
        self.color_cmyk_r3 = ["True", self.rgb_1, self.rgb_2, self.rgb_3, self.cmyk_1, self.cmyk_2, self.cmyk_3, self.cmyk_4]
        self.Settings_Save()
        # Display
    ...
    def Slider(self, mode, ch):
        if mode == "AAA":
            ...
            gradients = [
            [        0*hexRGB, self.rgb_2*hexRGB, self.rgb_3*hexRGB,          1*hexRGB, self.rgb_2*hexRGB, self.rgb_3*hexRGB],
            [self.rgb_1*hexRGB,         0*hexRGB, self.rgb_3*hexRGB, self.rgb_1*hexRGB,          1*hexRGB, self.rgb_3*hexRGB],
            [self.rgb_1*hexRGB, self.rgb_2*hexRGB,         0*hexRGB, self.rgb_1*hexRGB, self.rgb_2*hexRGB,          1*hexRGB]]
            slider_gradient = str(
    ...
    def Settings_Save(self):
        ...
        # UI
        ui_list = (str(self.layout.aaa.isChecked()), str(self.layout.rgb.isChecked()), str(self.layout.hsv.isChecked()), str(self.layout.hsl.isChecked()), str(self.layout.cmyk.isChecked()), str(self.layout.tip.isChecked()), str(self.layout.tts.isChecked()),  str(self.layout.mixer_selector.currentIndex()), str(self.layout.panel_selector.currentIndex()) )
        ui_string = ','.join(ui_list)
        Krita.instance().writeSetting("Pigment.O", "UI", ui_string)

    def Settings_Load_Color(self):
        # Active Color
        active_color_string = Krita.instance().readSetting("Pigment.O", "Active Color", "RGBA,U8,sRGB-elle-V2-srgbtrc.icc,1,0.8,0.4,1|RGBA,U8,sRGB-elle-V2-srgbtrc.icc,0,0,0,1")
        ...
        try:
            ...
            self.Color_RGB(0.0, 0.0, 0.0)
        # Clean Percentage Label Display
        self.Pigment_Display_Release(0)
    def Settings_Save_Color(self):
        # Active Color
        active_color_list = (str(self.rgb_1), str(self.rgb_2), str(self.rgb_3))
        active_color_string = ','.join(active_color_list)
        Krita.instance().writeSetting("Pigment.O", "Active Color", active_color_string)
