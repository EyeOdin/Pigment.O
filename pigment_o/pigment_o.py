...
class PigmentODocker(DockWidget):
    ...
    def Pigment_Display(self):
        ...
        if self.layout.gray.isChecked():
            ...
            # RGB
            sss_rgb1 = str(self.RGB_Gradient(self.layout.rgb_1_slider.width(), [0, self.rgb_2, self.rgb_3], [1, self.rgb_2, self.rgb_3]))
            sss_rgb2 = str(self.RGB_Gradient(self.layout.rgb_2_slider.width(), [self.rgb_1, 0, self.rgb_3], [self.rgb_1, 1, self.rgb_3]))
            sss_rgb3 = str(self.RGB_Gradient(self.layout.rgb_3_slider.width(), [self.rgb_1, self.rgb_2, 0], [self.rgb_1, self.rgb_2, 1]))
            # ARD
            ...
            # HSV
            sss_hsv1 = str(self.HUE_HSV_Gradient(0/hexHUE, 60/hexHUE, 120/hexHUE, 180/hexHUE, 240/hexHUE, 300/hexHUE, 360/hexHUE, self.hsv_2, self.hsv_3))
            ...
            # HSL
            sss_hsl1 = str(self.HUE_HSL_Gradient(0/hexHUE, 60/hexHUE, 120/hexHUE, 180/hexHUE, 240/hexHUE, 300/hexHUE, 360/hexHUE, self.hsl_2, self.hsl_3))
